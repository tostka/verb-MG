...
Describe 'Module Information' -Tags 'Command'{
    Context 'Manifest Testing' {
        ...
        It 'Valid Manifest GUID' {
            $Script:ManifestHash.Guid | Should -Be "ac3050f2-8b1c-4dca-b2e1-3cd3efeb607b"
        }
        <#
        It 'No Format File' {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUPKWxbJ05VRdaGXeSfzDRYNsT
# qbigggI4MIICNDCCAaGgAwIBAgIQWsnStFUuSIVNR8uhNSlE6TAJBgUrDgMCHQUA
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTumQf4
# RUoUImlDAiHjXt6AB1L8bDANBgkqhkiG9w0BAQEFAASBgET0BTQ238wihWeg697F
# sheMLnaejLStpj/E0shD7pc3kuBDM36omZ0o7tIgXEHyLO4r7ORSFAm8ADnerQiS
# QynA5Urneum1vxWT2+nqVxomPpIAYoGpPApKLo7CNysG+n79DFMgVRjDziQTp/U4
# vZDEUkSghVbRNvfAwwtDV+Xl
